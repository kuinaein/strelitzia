...
namespace Illuminate\Support\Facades {
  ...
  class Log {
     ...
     * @static
     */
    public static function write($level, $message, $context = []): void {
     ...
     * @static
     */
    public static function useFiles($path, $level = 'debug'): void {
     ...
     * @static
     */
    public static function useDailyFiles($path, $days = 0, $level = 'debug'): void {
     ...
     * @static
     */
    public static function useErrorLog($level = 'debug', $messageType = 0): void {
  ...
  class Mail {
     ...
     *
     * @param array|\Illuminate\Mail\MailableContract|string $view
     * @param array                                          $data
  ...
  class Request {
     ...
     * @static
     */
    public static function merge($input): void {
     ...
     * @static
     */
    public static function replace($input): void {
     ...
     * Gets the Session.
     *
     * @return null|\Symfony\Component\HttpFoundation\SessionInterface The session
     * @static
     */
    public static function getSession() {
      //Method inherited from \Symfony\Component\HttpFoundation\Request
     ...
     * @param string $key
     * @param mixed  $default
     * @return null|array|\Illuminate\Http\UploadedFile
     * @static
     */
  ...
  class Storage {
     ...
     * @static
     */
    public static function set($name, $disk): void {
  ...
  class Validator {
     ...
     * @static
     */
    public static function validate($data, $rules, $messages = [], $customAttributes = []): void {
